...
import { Flex, Heading, Box, Icon } from 'zbase';
import { zIndex, radius } from 'z-frontend-theme/utils';
          ...
          <ModalCard>
            <Card.Header>
              <Flex justify="space-between">
                ...
                <CloseIcon fontSize={2} mr={1} color="grayscale.d" onClick={props.onCancel} />
              </Flex>
            </Card.Header>
