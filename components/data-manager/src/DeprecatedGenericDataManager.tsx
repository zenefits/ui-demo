...
interface DeprecatedGenericDataManagerProps {
  configManager: ConfigManagerProps;
  children: (managerProps: GenericManagerRenderProps) => React.ReactNode;
}

export default class DeprecatedGenericDataManager extends React.Component<DeprecatedGenericDataManagerProps, {}> {
  ...
  render() {
    const { configs } = this.props.configManager;
    const filtering = {
