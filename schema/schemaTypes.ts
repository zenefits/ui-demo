...
export interface Query {
  ...
  paJobLevelSalaryBenchmark?:
    ...
    | null /** The paJobLevelSalaryBenchmark will be deprecated once job benchmarking page query moves to paJobBenchmarking */;
  ...
  companySetupMarketplacePlans?: (CompanySetupMarketplacePlan | null)[] | null;
  companySetupCoverageStartDates?: (Date | null)[] | null;
...
export interface Dashboard {
  ...
  isDemoAccount?: boolean | null /** DemoAccount model is not being used anymore. isDemoAccount will always be false */;
  isTrialPasswordless?: boolean | null;
  isTrialCompany?: boolean | null;
  isTrialSales?: boolean | null;
...
export interface CompanyAuxProxy {
  id?:
    | string
    | null /** fsa: FsaCompanyEnrollmentcompany401kEnrollment: Company401kEnrollmenthra: HraCompanyEnrollmentunicardCommuter: UnicardCommuterCompanyEnrollment */;
...
export interface ReviewersCollection {
  reviewersSelection: ReviewersSelection;
}
...
/** schema generated using server commit ff47c3f9435c1fcccf11a7eace25c60161e83d45 */
...
export interface Mutation {
  ...
  createOrUpdateReview?: Review | null /** talent -> reviews mutations */;
  ...
  createMeetingSpace?: MeetingSpace | null /** talent -> one on ones mutations */;
  ...
  logWellbeingEventData?: boolean | null /** talent -> wellbeing mutations */;
  ...
  generateReviewCycleReport?:
    | string
    | null /** TODO MASON: Make cycleEndDate required when frontend is released for ticked  TLNT-1036 */;
  ...
  saveContributionPreferences?: CompanySetupContributionSettings | null;
  saveContributionPreferencesV2?: CompanySetupContributionSettings | null;
  saveContributionSettings?: CompanySetupContributionSettings | null;
  saveCarrierSettings?: CompanySetupCarrierSettings | null;
  ...
  createFolder?: FolderActionResponse | null;
...
export interface CompanySetupMarketplacePlansQueryArgs {
  lineOfCoverage?: string | null;
}
...
export interface SaveContributionPreferencesMutationArgs {
  contributionPriority: string;
  workerContribution: string;
  dependentContribution: string;
}
export interface SaveContributionPreferencesV2MutationArgs {
...
export interface SaveCarrierSettingsMutationArgs {
  coverageStartDate?: Date | null;
  waitingPeriod?: string | null;
  terminationPolicy?: string | null;
}
