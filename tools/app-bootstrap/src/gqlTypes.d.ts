...
export namespace AppQuery {
  ...
  export type RolesPermissionsData = {
    __typename?: 'RolesPermissionsData';
    grants?: JSON | null;
    spans?: JSON | null;
  };
}
export namespace PermissionsRefreshQuery {
  export type Variables = {};
...
export namespace DemoCenterQuery {
  export type Variables = {};
...
export namespace WalkmeCompanySetupQuery {
  export type Variables = {};

  export type Query = {
    __typename?: 'Query';
    companySetupTasks: CompanySetupTasks[];
  };

  export type CompanySetupTasks = {
...
export namespace WalkmeUserDataQuery {
  export type Variables = {};
